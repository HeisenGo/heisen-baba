...
func UpdateVehicleRequestToDomain(req *UpdateVehicleReq) *vehicle.Vehicle {
	...
	if req.PricePerHour != nil {
		v.PricePerHour = *req.PricePerHour
	}
	if req.MotorNumber != nil {
		v.MotorNumber = *req.MotorNumber
	}
	if req.MinRequiredTechPerson != nil {
		v.MinRequiredTechPerson = *req.MinRequiredTechPerson
	}
	if req.IsActive != nil {
	...
	if req.ProductionYear != nil {
		v.ProductionYear = *req.ProductionYear
	}
	if req.IsConfirmedByAdmin != nil {
		v.IsConfirmedByAdmin = *req.IsConfirmedByAdmin
	}
	return v
}
